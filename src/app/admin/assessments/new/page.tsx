...
function ManualForm({ roleOptions }: { roleOptions: { value: string; label: string }[] }) {
  ...
  const [form, setForm] = useState({
    ...
    monitoringEnabled: true, requireCamera: false, requireMicrophone: false, requireScreen: false,
  });
